...
describe('gridRenderer', function () {
  ...
  describe('#render', function () {
    ...
    // TODO: this test now fails since I am now searching for a specific area that fits widget size
    xit('considers a minimum height of 1 when scaling widgets', function () {
